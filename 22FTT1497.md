...
- **Objectives: Start a python based simple web server inside a folder called “WADT AS1 PT2”**
...
- **Objectives: Student able to create SSH key pair**
...
- **Objectives: The SSH key pair named as wadt_as1 and wadt_as1.pub**
- **Objectives: The SSH key uses ed25519 encryption**
- **Objectives: SSH key comment (wadt_as1.pub) uses student’s PB email**
...
- **Objectives: NVM lists NodeJS latest version installed (non LTS) 21.5.1**
...
- **Objectives: NVM lists NodeJS latest LTS version installed 20.11.0**
...
- **Objectives: Use NVM to switch to non LTS and back to LTS**
...
- **Objectives: Runs NodeJS (i.e. node) and able to exit cleanly**
